...
export const getRadialBarChartConfig = (themeColors: ThemeInstance['themes']['value']['colors']) => {
  ...
  return {
    ...
    labels: ['Expected', 'Leave', 'Exempted', 'Absent', 'Present', 'Flexi Per Week', 'Running Late', 'Rest Day'],
    legend: {
      show: true,
      position: 'top',
      labels: {
    ...
    colors: [radialBarColors.series1, radialBarColors.series2, radialBarColors.series3, radialBarColors.series4, radialBarColors.series5, radialBarColors.series6, radialBarColors.series7, radialBarColors.series8],
    plotOptions: {
      radialBar: {
        hollow: { size: '30%' },
        track: {
...
export const getDonutChartConfig = (themeColors: ThemeInstance['themes']['value']['colors']) => {
  ...
  return {
    stroke: { width: 0 },
    labels: ['Expected', 'Leave', 'Exempted', 'Absent', 'Present', 'Flexi Per Week', 'Running Late', 'Rest Day'],
    colors: [donutColors.series1, donutColors.series2, donutColors.series3, donutColors.series4, donutColors.series5, donutColors.series6, donutColors.series7, donutColors.series8],
    dataLabels: {
      enabled: true,

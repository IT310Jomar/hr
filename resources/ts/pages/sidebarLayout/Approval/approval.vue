...
const getOvertimeRequestPending = () => {
    axios.get('/api/user/overtime/request')
        .then((response) => {
...
const getUndertimeRequestPending = () => {
    axios.get('/api/user/undertime/request')
        .then((response) => {
...
const getScheduleAdjustmentRequestPending = () => {
    axios.get('/api/user/schedule/adjustment')
        .then((response) => {
...
const getOfficalBusinessRequestPending = () => {
    axios.get('/api/user/business/request')
        .then((response) => {
...
const getLeave = () => {
    axios.get('/api/user/leave/request')
      .then((response) => {
...
const searchOvertime = (query: any) => {
    loading.value = true;
    axios.get('/api/user/overtime/request/search', {
        params: {
            query: query
        }
...
const searchUndertime = (query: any) => {
    loading.value = true;
    axios.get('/api/user/undertime/request/search', {
        params: {
            query: query
        }
...
const searchScheduleAdjustment = (query: any) => {
    loading.value = true;
    axios.get('/api/user/schedule/adjustment/search', {
        params: {
            query: query
        }
...
const searchOfficalBusiness = (query: any) => {
    loading.value = true;
    axios.get('/api/user/business/request/search', {
        params: {
            query: query
        }
...
const searchCash = (query: any) => {
    loading.value = true;
    axios.get('/api/user/cash/advance/search', {
        params: {
            query: query
        }
...
const searchLeave = (query: any) => {
    axios.get('/api/user/leave/request/search', {
        params: {
            query: query
        }
    }).then(response => {
